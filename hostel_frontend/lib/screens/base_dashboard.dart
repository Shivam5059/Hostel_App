...
class BaseDashboardState extends State<BaseDashboard> {
  ...
  void _onMenuSelected(int index) {
    ...
    setState(() {
      ...
      _currentPage = index == 0 ? const DashboardHomeView() : _functions[index - 1].page;
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      backgroundColor: AppTheme.primaryColor, // Deep indigo base for the premium side-over feel
        ...
        children: [
          Row(
            children: [
              if (isSmallScreen) ...[
                IconButton(
                  icon: const Icon(Icons.menu_rounded, color: AppTheme.textPrimaryColor),
              ...
              Column(
                ...
                children: [
                  Text(
                    _selectedIndex == 0 ? 'Overview' : _functions[_selectedIndex - 1].title,
          ...
          Row(
            children: [
              Container(
                ...
                child: IconButton(
                  icon: const Icon(Icons.notifications_none_rounded, color: AppTheme.textSecondaryColor),
                  onPressed: () {},
  ...
  Widget _buildSidebarContent(BuildContext context, {required bool isSmallScreen}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        Padding(
          padding: EdgeInsets.only(top: isSmallScreen ? 48.0 : 32.0, left: 24, right: 24, bottom: 32),
          child: Row(
            children: [
              Container(
        ...
        Expanded(
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final icon = index == 0 ? Icons.dashboard_rounded : _functions[index - 1].icon;
              final title = index == 0 ? 'Overview' : _functions[index - 1].title;
              return Container(
                ...
                child: Material(
                  ...
                  child: InkWell(
                    onTap: () {
                      if (isSmallScreen && Scaffold.of(context).isDrawerOpen) {
